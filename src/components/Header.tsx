  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-16 w-full h-16 md:h-24 border-b border-secondary m-0 p-0">
        ...
        {/* Console Section - hide on md, show from lg with smaller span */}
        <div ref={consoleRef} className="hidden lg:flex lg:col-span-1 xl:col-span-2 py-2 border-r border-secondary px-2 md:px-3">
        ...
        {/* Social Icons - increase grid on mobile and md */}
        <div ref={socialsRef} className="col-span-3 md:col-span-2 lg:col-span-1 border-r border-secondary">
          <div className="h-full flex flex-row md:flex-col items-stretch">
            <a href="https://codepen.io" className="flex-1 h-full flex items-center justify-center relative overflow-hidden group border-r border-secondary md:border-r-0 md:border-b">
              ...
              <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" className="relative z-10 text-secondary group-hover:text-primary transition-colors duration-300 w-5 h-5">
            ...
            <a href="https://linkedin.com" className="flex-1 h-full flex items-center justify-center relative overflow-hidden group">
              <div className="absolute inset-0 bg-secondary transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-out"></div>
              <span className="text-[20px] md:text-[20px] font-bold relative z-10 text-secondary group-hover:text-primary transition-colors duration-300">in</span>
            </a>
          </div>
        </div>
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center px-4">
              <div className="text-xs">
                <span className="hidden md:inline">Available for freelance work → </span><span className="font-bold">Hire me</span>
              </div>
            </div>
          </div>
        </aside>

        {/* QR Code - 1 column (smaller on md) */}
        <div className="col-span-1 hidden md:flex items-center justify-center">
          ...
          >
            <Image
              ...
              width={40}
              height={40}
              className="w-8 h-8 md:w-8 md:h-8 object-contain border border-secondary"
              priority
            />
          </a>
        </div>
